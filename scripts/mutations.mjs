...
const cases=[
  ...
  {id:'M12-usage-hour-bucket',file:'src/usage-evidence.js',from:"if (buckets.get(activity.instanceId) === bucket) return;",to:"if (false) return; /* MUTATION: every forwarded request becomes a use event */",test:'tests/usage-evidence.test.mjs',pattern:'^AH-U02:',reason:/Expected values to be strictly equal|strictly deep-equal/},
